 ...
 */
inline fun <reified T : View> Fragment.findView(@IdRes id: Int): T? = view?.findViewById(id)
 ...
 * @return The view that has the given id in the hierarchy or null
 */
inline fun <reified T : View> android.support.v4.app.Fragment.findView(id: Int): T? = view?.findViewById(id)
 ...
 */
@RequiresApi(Build.VERSION_CODES.LOLLIPOP)
fun android.support.v4.app.Fragment.getResDrawable(resId: Int): Drawable = resources.getDrawable(resId, null)
